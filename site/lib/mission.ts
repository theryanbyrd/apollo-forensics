...
export const EVENTS: MissionEvent[] = [
  ...
  },
  {
    ...
    computing:
      "P11 confirms insertion velocity against the target, then the crew keys V37E 00E — the CMC drops to P00, its background job: integrating the state vector and keeping the platform aligned.",
  ...
  },
  {
    ...
    computing:
      "P30 accepts the ground-computed ΔV target; P40 steers the burn — cross-product steering, the same guidance law that will fly the lunar landing — and cuts off within 0.1 ft/s.",
  ...
  },
  {
    ...
    narration:
      "Behind the Moon again: a gentle 30-second burn of the descent engine drops Eagle's orbit to 50,000 feet above the Sea of Tranquility — the doorstep of the landing.",
    computing:
  ...
  },
  {
    ...
    computing:
      "The CMC's last display counts down range-to-go to zero. Total computing hardware that flew the mission: 4 KB of RAM, 72 KB of ROM, 55 watts — and it was enough, with margin.",
