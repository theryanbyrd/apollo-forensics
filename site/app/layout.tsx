  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-50 focus:rounded-lg focus:bg-el focus:px-4 focus:py-2 focus:text-sm focus:font-bold focus:text-neutral-950"
        >
          Skip to content
        </a>
        <Nav />
