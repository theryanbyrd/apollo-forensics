...
| [20](claims/20-foreign-orbiters/) | (Independence check) Non-NASA orbiters | Terrain-match 1971 photos vs JAXA Kaguya elevation data | ✅ **CONFIRMED (anti-hoax)** — Japan's 2008 Kaguya DEM reproduces the 1971 Apollo 15 photo skylines to ~0.2° RMS (r = 0.998), at exactly the documented viewing directions |
