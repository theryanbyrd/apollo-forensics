...
| [10](claims/10-wire-rigs/) | Astronauts on wires | Acceleration-profile analysis of jumps and falls | ✅ **REFUTED** — both jump-salute jumps fit free ballistic flight at g = 1.68 and 1.67 ± 0.11 m/s² with ~2 mm residuals; no tension event, against a test that catches an 8–11 cm/s impulse 95% of the time, and no wire above the helmet down to 0.16 mm sunlit |
