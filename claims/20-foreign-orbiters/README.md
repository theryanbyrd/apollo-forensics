...
| Best-fit boresight azimuth | **184.8°** (skyline spans 162–208°) | **46.3°** (spans 39–68°) |
...
| RMS residual (pitch/roll fitted) | **0.179°** | **0.208°** |
| Pearson r | **0.9985** | **0.9951** |
| 2nd-best RMS anywhere else on the 360° circle | 1.55° (8.7× worse) | 0.65° (3.1× worse) |
| Fitted pose | pitch −1.1°, roll +1.8° | pitch −7.8°, roll −0.5° |

The 2008 Japanese DEM reproduces the 1971 skylines to about **0.2° RMS**
— roughly 15 pixels on the film scans, across 29–46° of panorama — and
the best-fit pointing lands exactly where the mission transcript says the
...
- The horizon is rendered from the LM coordinates; the photos were taken
  ...
  (~1–8 km away) shows a small residual consistent with this parallax.
...
- In AS15-86-11603 the shadowed WNW flank of Mons Hadley (left third) is
  ...
  veiling glare and relies on the seam tracker's crest detection.
...
photographed by Apollo 15 astronauts in 1971 matches, to ~0.2° RMS and at
the documented viewing azimuths, an elevation model measured 36+ years
later by a Japanese orbiter that no 1971 set designer could have had. For
